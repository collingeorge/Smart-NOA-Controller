"""
Unit tests for Smart NOA Controller (Educational Simulation)
Tests core safety interlock logic, constraint enforcement, and simulated dose calculations.
This is an educational project — not for clinical use.
"""
...
class TestContraindications(unittest.TestCase):
    ...
    def test_heart_block_locks_dexmedetomidine(self):
        """Simulated profile with heart block should have dexmedetomidine hard-locked"""
        patient = Patient(
            age=72,
            weight_kg=70,
            asa_class=3,
    ...
    def test_low_egfr_locks_ketorolac(self):
        """Simulated profile with eGFR < 30 should have ketorolac hard-locked"""
        patient = Patient(
            age=65,
            weight_kg=75,
            asa_class=3,
    ...
    def test_nsaid_allergy_locks_ketorolac(self):
        """Simulated profile with NSAID allergy should have ketorolac hard-locked"""
        patient = Patient(
            age=45,
            weight_kg=80,
            asa_class=2,
    ...
    def test_healthy_patient_no_lockouts(self):
        """Healthy simulated profile should have no hard lockouts"""
        patient = Patient(
            age=35,
            weight_kg=70,
            asa_class=1,
...
class TestAgeDosing(unittest.TestCase):
    ...
    def test_geriatric_dexmedetomidine_reduction(self):
        """Simulated geriatric profile (> 65) should get 50% dexmedetomidine dose reduction"""
        patient = Patient(
            age=78,
            weight_kg=65,
            asa_class=3,
        ...
        self.assertEqual(rates["Dexmedetomidine"], 0.25,
                        "Geriatric profiles should get 0.25 mcg/kg/hr dex dose")
    
    def test_young_adult_standard_dosing(self):
        """Simulated adult profile (< 65) should get standard dexmedetomidine dose"""
        patient = Patient(
            age=42,
            weight_kg=75,
            asa_class=2,
    ...
    def test_boundary_age_65(self):
        """Profile at age boundary (65) should not trigger geriatric dose reduction"""
        patient = Patient(
            age=65,
            weight_kg=70,
            asa_class=2,
...
class TestPharmacokinetics(unittest.TestCase):
    ...
    def test_pk_concentration_increases_with_infusion(self):
        ...
        # Simulate 10 minutes of infusion at 35 mcg/min (0.5 mcg/kg/hr for 70kg subject)
        for _ in range(10):
